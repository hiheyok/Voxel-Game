...
class GenLayerBiome : public GenLayer {
 ...
 public:
  GenLayerBiome(int64_t baseSeedIn, GenLayer* parentIn,
        ...
        if (settings_ != nullptr && settings_->fixedBiome >= 0) {
          ...
          if (l > 0) {
            ...
            aint1[j + i * areaWidth] = Biome::getIdForBiome(
                warmBiomes[NextInt(static_cast<int>(warmBiomes.size()))]);
          }
        } else if (k == 2) {
          if (l > 0) {
            ...
            aint1[j + i * areaWidth] = Biome::getIdForBiome(
                mediumBiomes[NextInt(static_cast<int>(mediumBiomes.size()))]);
          }
        } else if (k == 3) {
          if (l > 0) {
            aint1[j + i * areaWidth] =
            ...
            aint1[j + i * areaWidth] = Biome::getIdForBiome(
                coldBiomes[NextInt(static_cast<int>(coldBiomes.size()))]);
          }
        } else if (k == 4) {
          aint1[j + i * areaWidth] = Biome::getIdForBiome(
