...
class GenLayerHills : public GenLayer {
   ...
   public:
    GenLayerHills(long long baseSeedIn, GenLayer* parentIn,
                  GenLayer* riverLayerIn)
        : GenLayer(baseSeedIn) {
        parent = parentIn;
    ...
    std::vector<int> getInts(int areaX, int areaY, int areaWidth,
        ...
        std::vector<int> aint1 = riverLayer->getInts(
            areaX - 1, areaY - 1, areaWidth + 2, areaHeight + 2);
