...
class GenLayerShore : public GenLayer {
 private:
  void replaceIfNeighborOcean(std::vector<int>& p_151632_1_,
                              ...
                              int p_151632_4_, int p_151632_5_, int p_151632_6_,
                              int p_151632_7_) {
    if (isBiomeOceanic(p_151632_6_)) {
      ...
      if (!isBiomeOceanic(i) && !isBiomeOceanic(j) && !isBiomeOceanic(k) &&
          !isBiomeOceanic(l)) {
        p_151632_2_[p_151632_3_ + p_151632_4_ * p_151632_5_] = p_151632_6_;
      } else {
 ...
 public:
  GenLayerShore(int64_t baseSeedIn, GenLayer* parentIn) : GenLayer(baseSeedIn) {
    parent = parentIn;
  }
      ...
      for (int j = 0; j < areaWidth; ++j) {
        ...
        if (k == Biome::getIdForBiome(Biomes::MUSHROOM_ISLAND)) {
          ...
          if (biome != nullptr && biome->isSnowyBiome()) {
            replaceIfNeighborOcean(aint, aint1, j, i, areaWidth, k,
