...
class Biomes {
   public:
    ...
    static void RegisterBiome() {
        Biome::Register(0, "ocean",
                        new BiomeOcean(BiomeProperties("Ocean")
                                           .setBaseHeight(-1.0F)
                                           .setHeightVariation(0.1F)));
        Biome::Register(1, "plains",
                        new BiomePlains(false, BiomeProperties("Plains")
                                                   .setBaseHeight(0.125F)
                                                   .setHeightVariation(0.05F)
                                                   .setTemperature(0.8F)
                                                   .setRainfall(0.4F)));
        Biome::Register(2, "desert",
                        new BiomeDesert(BiomeProperties("Desert")
                                            .setBaseHeight(0.125F)
                                            .setHeightVariation(0.05F)
                                            .setTemperature(2.0F)
                                            .setRainfall(0.0F)
                                            .setRainDisabled()));
        Biome::Register(3, "extreme_hills",
                        new BiomeHills(BiomeHills::Type::NORMAL,
                                       BiomeProperties("Extreme Hills")
                                           .setBaseHeight(1.0F)
        ...
        Biome::Register(
            ...
            new BiomeForest(
                ...
                BiomeProperties("Forest").setTemperature(0.7F).setRainfall(
                    0.8F)));
        Biome::Register(5, "taiga",
                        new BiomeTaiga(BiomeTaiga::Type::NORMAL,
                                       BiomeProperties("Taiga")
                                           .setBaseHeight(0.2F)
                                           .setHeightVariation(0.2F)
                                           .setTemperature(0.25F)
                                           .setRainfall(0.8F)));
        Biome::Register(6, "swampland",
                        new BiomeSwamp(BiomeProperties("Swampland")
                                           .setBaseHeight(-0.2F)
                                           .setHeightVariation(0.1F)
                                           .setTemperature(0.8F)
                                           .setRainfall(0.9F)
                                           .setWaterColor(14745518)));
        Biome::Register(7, "river",
                        new BiomeRiver(BiomeProperties("River")
                                           .setBaseHeight(-0.5F)
                                           .setHeightVariation(0.0F)));
        Biome::Register(8, "hell",
                        new BiomeHell(BiomeProperties("Hell")
                                          .setTemperature(2.0F)
                                          .setRainfall(0.0F)
                                          .setRainDisabled()));
        Biome::Register(
            9, "sky",
            new BiomeEnd(BiomeProperties("The End").setRainDisabled()));
        Biome::Register(10, "frozen_ocean",
                        new BiomeOcean(BiomeProperties("FrozenOcean")
                                           .setBaseHeight(-1.0F)
                                           .setHeightVariation(0.1F)
                                           .setTemperature(0.0F)
                                           .setRainfall(0.5F)
                                           .setSnowEnabled()));
        Biome::Register(11, "frozen_river",
                        new BiomeRiver(BiomeProperties("FrozenRiver")
                                           .setBaseHeight(-0.5F)
                                           .setHeightVariation(0.0F)
                                           .setTemperature(0.0F)
                                           .setRainfall(0.5F)
                                           .setSnowEnabled()));
        Biome::Register(12, "ice_flats",
                        new BiomeSnow(false, BiomeProperties("Ice Plains")
                                                 .setBaseHeight(0.125F)
                                                 .setHeightVariation(0.05F)
                                                 .setTemperature(0.0F)
                                                 .setRainfall(0.5F)
                                                 .setSnowEnabled()));
        Biome::Register(13, "ice_mountains",
                        new BiomeSnow(false, BiomeProperties("Ice Mountains")
                                                 .setBaseHeight(0.45F)
        ...
        Biome::Register(
            14, "mushroom_island",
            new BiomeMushroomIsland(BiomeProperties("MushroomIsland")
                                        .setBaseHeight(0.2F)
                                        .setHeightVariation(0.3F)
                                        .setTemperature(0.9F)
                                        .setRainfall(1.0F)));
        Biome::Register(
            ...
            new BiomeMushroomIsland(BiomeProperties("MushroomIslandShore")
                                        .setBaseHeight(0.0F)
                                        .setHeightVariation(0.025F)
                                        .setTemperature(0.9F)
                                        .setRainfall(1.0F)));
        Biome::Register(16, "beaches",
                        new BiomeBeach(BiomeProperties("Beach")
                                           .setBaseHeight(0.0F)
                                           .setHeightVariation(0.025F)
                                           .setTemperature(0.8F)
                                           .setRainfall(0.4F)));
        Biome::Register(17, "desert_hills",
                        new BiomeDesert(BiomeProperties("DesertHills")
                                            .setBaseHeight(0.45F)
                                            .setHeightVariation(0.3F)
                                            .setTemperature(2.0F)
                                            .setRainfall(0.0F)
                                            .setRainDisabled()));
        Biome::Register(18, "forest_hills",
                        new BiomeForest(BiomeForest::Type::NORMAL,
                                        BiomeProperties("ForestHills")
                                            .setBaseHeight(0.45F)
                                            .setHeightVariation(0.3F)
                                            .setTemperature(0.7F)
                                            .setRainfall(0.8F)));
        Biome::Register(19, "taiga_hills",
                        new BiomeTaiga(BiomeTaiga::Type::NORMAL,
                                       BiomeProperties("TaigaHills")
                                           .setTemperature(0.25F)
                                           .setRainfall(0.8F)
                                           .setBaseHeight(0.45F)
                                           .setHeightVariation(0.3F)));
        Biome::Register(20, "smaller_extreme_hills",
                        new BiomeHills(BiomeHills::Type::EXTRA_TREES,
                                       BiomeProperties("Extreme Hills Edge")
                                           .setBaseHeight(0.8F)
                                           .setHeightVariation(0.3F)
                                           .setTemperature(0.2F)
                                           .setRainfall(0.3F)));
        Biome::Register(21, "jungle",
                        new BiomeJungle(false, BiomeProperties("Jungle")
                                                   .setTemperature(0.95F)
                                                   .setRainfall(0.9F)));
        Biome::Register(22, "jungle_hills",
                        new BiomeJungle(false, BiomeProperties("JungleHills")
                                                   .setBaseHeight(0.45F)
                                                   .setHeightVariation(0.3F)
                                                   .setTemperature(0.95F)
                                                   .setRainfall(0.9F)));
        Biome::Register(23, "jungle_edge",
                        new BiomeJungle(true, BiomeProperties("JungleEdge")
                                                  .setTemperature(0.95F)
                                                  .setRainfall(0.8F)));
        Biome::Register(24, "deep_ocean",
                        new BiomeOcean(BiomeProperties("Deep Ocean")
                                           .setBaseHeight(-1.8F)
                                           .setHeightVariation(0.1F)));
        Biome::Register(25, "stone_beach",
                        new BiomeStoneBeach(BiomeProperties("Stone Beach")
                                                .setBaseHeight(0.1F)
                                                .setHeightVariation(0.8F)
                                                .setTemperature(0.2F)
                                                .setRainfall(0.3F)));
        Biome::Register(26, "cold_beach",
                        new BiomeBeach(BiomeProperties("Cold Beach")
                                           .setBaseHeight(0.0F)
                                           .setHeightVariation(0.025F)
                                           .setTemperature(0.05F)
                                           .setRainfall(0.3F)
                                           .setSnowEnabled()));
        Biome::Register(27, "birch_forest",
                        new BiomeForest(BiomeForest::Type::BIRCH,
                                        BiomeProperties("Birch Forest")
                                            .setTemperature(0.6F)
                                            .setRainfall(0.6F)));
        Biome::Register(28, "birch_forest_hills",
                        new BiomeForest(BiomeForest::Type::BIRCH,
                                        BiomeProperties("Birch Forest Hills")
                                            .setBaseHeight(0.45F)
                                            .setHeightVariation(0.3F)
                                            .setTemperature(0.6F)
                                            .setRainfall(0.6F)));
        Biome::Register(29, "roofed_forest",
                        new BiomeForest(BiomeForest::Type::ROOFED,
                                        BiomeProperties("Roofed Forest")
                                            .setTemperature(0.7F)
                                            .setRainfall(0.8F)));
        Biome::Register(30, "taiga_cold",
                        new BiomeTaiga(BiomeTaiga::Type::NORMAL,
                                       BiomeProperties("Cold Taiga")
                                           .setBaseHeight(0.2F)
                                           .setHeightVariation(0.2F)
                                           .setTemperature(-0.5F)
                                           .setRainfall(0.4F)
                                           .setSnowEnabled()));
        Biome::Register(31, "taiga_cold_hills",
                        new BiomeTaiga(BiomeTaiga::Type::NORMAL,
                                       BiomeProperties("Cold Taiga Hills")
                                           .setBaseHeight(0.45F)
                                           .setHeightVariation(0.3F)
                                           .setTemperature(-0.5F)
                                           .setRainfall(0.4F)
                                           .setSnowEnabled()));
        Biome::Register(32, "redwood_taiga",
                        new BiomeTaiga(BiomeTaiga::Type::MEGA,
                                       BiomeProperties("Mega Taiga")
                                           .setTemperature(0.3F)
                                           .setRainfall(0.8F)
                                           .setBaseHeight(0.2F)
                                           .setHeightVariation(0.2F)));
        Biome::Register(33, "redwood_taiga_hills",
                        new BiomeTaiga(BiomeTaiga::Type::MEGA,
                                       BiomeProperties("Mega Taiga Hills")
                                           .setBaseHeight(0.45F)
                                           .setHeightVariation(0.3F)
                                           .setTemperature(0.3F)
                                           .setRainfall(0.8F)));
        Biome::Register(34, "extreme_hills_with_trees",
                        new BiomeHills(BiomeHills::Type::EXTRA_TREES,
                                       BiomeProperties("Extreme Hills+")
                                           .setBaseHeight(1.0F)
                                           .setHeightVariation(0.5F)
                                           .setTemperature(0.2F)
                                           .setRainfall(0.3F)));
        Biome::Register(35, "savanna",
                        new BiomeSavanna(BiomeProperties("Savanna")
                                             .setBaseHeight(0.125F)
                                             .setHeightVariation(0.05F)
                                             .setTemperature(1.2F)
                                             .setRainfall(0.0F)
                                             .setRainDisabled()));
        Biome::Register(36, "savanna_rock",
                        new BiomeSavanna(BiomeProperties("Savanna Plateau")
                                             .setBaseHeight(1.5F)
                                             .setHeightVariation(0.025F)
                                             .setTemperature(1.0F)
                                             .setRainfall(0.0F)
                                             .setRainDisabled()));
        Biome::Register(37, "mesa",
                        new BiomeMesa(false, false,
                                      BiomeProperties("Mesa")
                                          .setTemperature(2.0F)
                                          .setRainfall(0.0F)
                                          .setRainDisabled()));
        Biome::Register(38, "mesa_rock",
                        new BiomeMesa(false, true,
                                      BiomeProperties("Mesa Plateau F")
                                          .setBaseHeight(1.5F)
                                          .setHeightVariation(0.025F)
                                          .setTemperature(2.0F)
                                          .setRainfall(0.0F)
                                          .setRainDisabled()));
        Biome::Register(39, "mesa_clear_rock",
                        new BiomeMesa(false, false,
                                      BiomeProperties("Mesa Plateau")
                                          .setBaseHeight(1.5F)
                                          .setHeightVariation(0.025F)
                                          .setTemperature(2.0F)
                                          .setRainfall(0.0F)
        ...
        Biome::Register(
            127, "void",
            new BiomeVoid(BiomeProperties("The Void").setRainDisabled()));
        Biome::Register(
            129, "mutated_plains",
            new BiomePlains(true, BiomeProperties("Sunflower Plains")
                                      .setBaseBiome("plains")
                                      .setBaseHeight(0.125F)
                                      .setHeightVariation(0.05F)
                                      .setTemperature(0.8F)
                                      .setRainfall(0.4F)));
        Biome::Register(130, "mutated_desert",
                        new BiomeDesert(BiomeProperties("Desert M")
                                            .setBaseBiome("desert")
                                            ...
                                            .setRainfall(0.0F)
                                            .setRainDisabled()));
        Biome::Register(131, "mutated_extreme_hills",
                        new BiomeHills(BiomeHills::Type::MUTATED,
                                       BiomeProperties("Extreme Hills M")
                                           .setBaseBiome("extreme_hills")
                                           .setBaseHeight(1.0F)
                                           .setHeightVariation(0.5F)
                                           .setTemperature(0.2F)
                                           .setRainfall(0.3F)));
        Biome::Register(132, "mutated_forest",
                        new BiomeForest(BiomeForest::Type::FLOWER,
                                        BiomeProperties("Flower Forest")
                                            .setBaseBiome("forest")
                                            .setHeightVariation(0.4F)
                                            .setTemperature(0.7F)
                                            .setRainfall(0.8F)));
        Biome::Register(133, "mutated_taiga",
                        new BiomeTaiga(BiomeTaiga::Type::NORMAL,
                                       BiomeProperties("Taiga M")
                                           .setBaseBiome("taiga")
                                           .setBaseHeight(0.3F)
                                           .setHeightVariation(0.4F)
                                           .setTemperature(0.25F)
                                           .setRainfall(0.8F)));
        Biome::Register(134, "mutated_swampland",
                        new BiomeSwamp(BiomeProperties("Swampland M")
                                           ...
                                           .setRainfall(0.9F)
                                           .setWaterColor(14745518)));
        Biome::Register(140, "mutated_ice_flats",
                        new BiomeSnow(true, BiomeProperties("Ice Plains Spikes")
                                                ...
                                                .setRainfall(0.5F)
                                                .setSnowEnabled()));
        Biome::Register(149, "mutated_jungle",
                        new BiomeJungle(false, BiomeProperties("Jungle M")
                                                   .setBaseBiome("jungle")
                                                   .setBaseHeight(0.2F)
                                                   .setHeightVariation(0.4F)
                                                   .setTemperature(0.95F)
                                                   .setRainfall(0.9F)));
        Biome::Register(151, "mutated_jungle_edge",
                        new BiomeJungle(true, BiomeProperties("JungleEdge M")
                                                  .setBaseBiome("jungle_edge")
                                                  .setBaseHeight(0.2F)
                                                  .setHeightVariation(0.4F)
                                                  .setTemperature(0.95F)
                                                  .setRainfall(0.8F)));
        Biome::Register(155, "mutated_birch_forest",
                        new BiomeForestMutated(BiomeProperties("Birch Forest M")
        ...
        Biome::Register(
            ...
            new BiomeForestMutated(BiomeProperties("Birch Forest Hills M")
                                       .setBaseBiome("birch_forest_hills")
                                       .setBaseHeight(0.55F)
                                       .setHeightVariation(0.5F)
                                       .setTemperature(0.6F)
                                       .setRainfall(0.6F)));
        Biome::Register(157, "mutated_roofed_forest",
                        new BiomeForest(BiomeForest::Type::ROOFED,
                                        BiomeProperties("Roofed Forest M")
                                            .setBaseBiome("roofed_forest")
                                            .setBaseHeight(0.2F)
                                            .setHeightVariation(0.4F)
                                            .setTemperature(0.7F)
                                            .setRainfall(0.8F)));
        Biome::Register(158, "mutated_taiga_cold",
                        new BiomeTaiga(BiomeTaiga::Type::NORMAL,
                                       BiomeProperties("Cold Taiga M")
                                           ...
                                           .setRainfall(0.4F)
                                           .setSnowEnabled()));
        Biome::Register(160, "mutated_redwood_taiga",
                        new BiomeTaiga(BiomeTaiga::Type::MEGA_SPRUCE,
                                       BiomeProperties("Mega Spruce Taiga")
                                           .setBaseBiome("redwood_taiga")
                                           .setBaseHeight(0.2F)
                                           .setHeightVariation(0.2F)
                                           .setTemperature(0.25F)
                                           .setRainfall(0.8F)));
        Biome::Register(161, "mutated_redwood_taiga_hills",
                        new BiomeTaiga(BiomeTaiga::Type::MEGA_SPRUCE,
                                       BiomeProperties("Redwood Taiga Hills M")
        ...
        Biome::Register(
            ...
            new BiomeHills(BiomeHills::Type::MUTATED,
                           BiomeProperties("Extreme Hills+ M")
                               ...
                               .setTemperature(0.2F)
                               .setRainfall(0.3F)));
        Biome::Register(163, "mutated_savanna",
                        new BiomeSavannaMutated(BiomeProperties("Savanna M")
        ...
        Biome::Register(
            ...
            new BiomeSavannaMutated(BiomeProperties("Savanna Plateau M")
                                        ...
                                        .setRainfall(0.0F)
                                        .setRainDisabled()));
        Biome::Register(165, "mutated_mesa",
                        new BiomeMesa(true, false,
                                      BiomeProperties("Mesa (Bryce)")
                                          .setBaseBiome("mesa")
                                          .setTemperature(2.0F)
                                          .setRainfall(0.0F)
                                          .setRainDisabled()));
        Biome::Register(166, "mutated_mesa_rock",
                        new BiomeMesa(false, true,
                                      BiomeProperties("Mesa Plateau F M")
                                          ...
                                          .setRainfall(0.0F)
                                          .setRainDisabled()));
        Biome::Register(167, "mutated_mesa_clear_rock",
                        new BiomeMesa(false, false,
                                      BiomeProperties("Mesa Plateau M")
        ...
        Biomes::MUSHROOM_ISLAND_SHORE =
            getRegisteredBiome("mushroom_island_shore");
        ...
        Biomes::EXTREME_HILLS_EDGE =
            getRegisteredBiome("smaller_extreme_hills");
        ...
        Biomes::EXTREME_HILLS_WITH_TREES =
            getRegisteredBiome("extreme_hills_with_trees");
        ...
        Biomes::MUTATED_EXTREME_HILLS =
            getRegisteredBiome("mutated_extreme_hills");
