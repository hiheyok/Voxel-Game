 ...
 public:
  ...
  static void RegisterBiome() {
    Biome::Register(
        0, "ocean",
        new BiomeOcean(
            BiomeProperties("Ocean").setBaseHeight(-1.0F).setHeightVariation(
                0.1F)));
    ...
    Biome::Register(
        ...
        new BiomeForest(
            ...
            BiomeProperties("Forest").setTemperature(0.7F).setRainfall(0.8F)));
    Biome::Register(
        5, "taiga",
        new BiomeTaiga(BiomeTaiga::Type::NORMAL, BiomeProperties("Taiga")
                                                     .setBaseHeight(0.2F)
    ...
    Biome::Register(
        7, "river",
        new BiomeRiver(
            BiomeProperties("River").setBaseHeight(-0.5F).setHeightVariation(
                0.0F)));
    ...
    Biome::Register(13, "ice_mountains",
                    new BiomeSnow(false, BiomeProperties("Ice Mountains")
                                             ...
                                             .setRainfall(0.5F)
                                             .setSnowEnabled()));
    Biome::Register(14, "mushroom_island",
    ...
    Biome::Register(
        ...
        new BiomeJungle(
            false,
            BiomeProperties("Jungle").setTemperature(0.95F).setRainfall(0.9F)));
    ...
    Biome::Register(
        30, "taiga_cold",
        new BiomeTaiga(BiomeTaiga::Type::NORMAL, BiomeProperties("Cold Taiga")
                                                     .setBaseHeight(0.2F)
                                                     .setHeightVariation(0.2F)
                                                     .setTemperature(-0.5F)
                                                     .setRainfall(0.4F)
    ...
    Biome::Register(
        32, "redwood_taiga",
        new BiomeTaiga(BiomeTaiga::Type::MEGA, BiomeProperties("Mega Taiga")
                                                   .setTemperature(0.3F)
                                                   .setRainfall(0.8F)
                                                   .setBaseHeight(0.2F)
                                                   .setHeightVariation(0.2F)));
    ...
    Biome::Register(129, "mutated_plains",
    ...
    Biome::Register(
        133, "mutated_taiga",
        new BiomeTaiga(BiomeTaiga::Type::NORMAL, BiomeProperties("Taiga M")
                                                     .setBaseBiome("taiga")
                                                     .setBaseHeight(0.3F)
                                                     .setHeightVariation(0.4F)
                                                     .setTemperature(0.25F)
    ...
    Biome::Register(
        ...
        new BiomeTaiga(BiomeTaiga::Type::NORMAL, BiomeProperties("Cold Taiga M")
    ...
    Biome::Register(161, "mutated_redwood_taiga_hills",
                    new BiomeTaiga(BiomeTaiga::Type::MEGA_SPRUCE,
                                   BiomeProperties("Redwood Taiga Hills M")
                                       ...
                                       .setTemperature(0.25F)
                                       .setRainfall(0.8F)));
    Biome::Register(162, "mutated_extreme_hills_with_trees",
                    new BiomeHills(BiomeHills::Type::MUTATED,
                                   BiomeProperties("Extreme Hills+ M")
    ...
    Biome::Register(163, "mutated_savanna",
                    new BiomeSavannaMutated(BiomeProperties("Savanna M")
                                                ...
                                                .setRainfall(0.0F)
                                                .setRainDisabled()));
    Biome::Register(164, "mutated_savanna_rock",
