...
ChunkRawData::ChunkRawData(const Palette& chunkData, const LightStorage& lightData, const ChunkPos& pos) : chunk_data_{ chunkData }, lighting_data_{ lightData }, pos_{ pos } {};
