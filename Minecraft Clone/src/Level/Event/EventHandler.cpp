...
EventID EventHandler::RegisterBlockEvent(void (*func)(const BlockEvent&, Dimension*)) {
    block_event_handles_[event_count_] = func;
    return event_count_++;
}
EventID EventHandler::RegisterEntityEvent(void (*func)(const EntityEvent&, Dimension*)) {
